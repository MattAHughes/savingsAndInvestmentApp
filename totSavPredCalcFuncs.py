...
"(Optional ~ $)"))
        self.key_op_pg_cont_label_2.setToolTip(_translate("TabWidget", "<html><head/><body><p><span style=\" font-weight:400;\">Optional post savings goal fortnightly contribution to savings as an unformatted number.</span></p><p><br/></p><p><span style=\" font-weight:400;\">Assumed to be $(Initial Savings Contribution - Post-Savings Goal Contribution) if unfilled.</span></p></body></html>"))
...
"(Optional ~ $ per Fortnight)"))
        ...
        self.key_cust_goal_cont_lineEdit_2.setToolTip(_translate("TabWidget", "<html><head/><body><p>Optional post savings goal fortnightly contribution to savings as an unformatted number.</p><p><br/></p><p>Assumed to be $(Initial Savings Contribution - Post-Savings Goal Contribution) if unfilled.</p></body></html>"))
