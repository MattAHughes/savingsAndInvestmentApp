...
class relevantFunctions():
    ...
    def loadDefaultValues(self):
        ...
        # If the required directories do not exist, then create them at the current location
        req_path_1 = module_dir + "\\default_values"
        req_path_2 = module_dir + "\\user_inputs"
        if not os.path.exists(req_path_1):
            os.makedirs(req_path_1)
        if not os.path.exists(req_path_2):
            os.makedirs(req_path_2)
